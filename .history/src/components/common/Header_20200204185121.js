...
export class Header extends Component {
      ...
      <div className="row">
        ...
        <div className="col-sm-4 offset-md-1 py-4">
          ...
          <ul className="list-unstyled">
            <li><NavLink className="text-white">Follow on Twitter</a></li>
            <li><NavLink className="text-white">Like on Facebook</a></li>
            <li><NavLink className="text-white">Email me</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div className="navbar navbar-dark bg-dark shadow-sm">
    <div className="container d-flex justify-content-between">
      <NavLink className="navbar-brand d-flex align-items-center">
